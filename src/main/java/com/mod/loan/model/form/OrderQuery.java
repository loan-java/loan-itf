package com.mod.loan.model.form;
...
public class OrderQuery {
	...
	public String toString() {
		String obj = "";
		obj += merchant == null ? "" : "merchant=" + merchant + ",";
		obj += orderStatus == null ? "" : "orderStatus=" + orderStatus + ",";
		obj += followUserId == null ? "" : "followUserId=" + followUserId + ",";
		obj += userType == null ? "" : "userType=" + userType + ",";
		obj += borrowDayDown == null ? "" : "borrowDayDown=" + borrowDayDown + ",";
		obj += borrowDayUp == null ? "" : "borrowDayUp=" + borrowDayUp + ",";
		obj += createTimeDown == null ? "" : "createTimeDown=" + createTimeDown + ",";
		obj += createTimeUp == null ? "" : "createTimeUp=" + createTimeUp + ",";
		obj += arriveTimeDown == null ? "" : "arriveTimeDown=" + arriveTimeDown + ",";
		obj += arriveTimeUp == null ? "" : "arriveTimeUp=" + arriveTimeUp + ",";
		obj += repayTimeDown == null ? "" : "repayTimeDown=" + repayTimeDown + ",";
		obj += repayTimeUp == null ? "" : "repayTimeUp=" + repayTimeUp + ",";
		obj += userPhone == null ? "" : "userPhone=" + userPhone + ",";
		obj += userName == null ? "" : "userName=" + userName + ",";
